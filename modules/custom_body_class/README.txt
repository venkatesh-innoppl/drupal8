...
Custom body class module is used to add custom class to <body> tag specific to node.
...
CONFIGURATION
-------------
This module adds a fieldset named "Custom Body Class Settings" in node type form,
...
2:  A checkbox,which when enabled add a node type as a class in <body> tag.
    For eg: If a node type is article, then 'article' get added as a class in <body> tag of the page.
